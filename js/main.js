...
function getColor() {
    var colorNames = ["ROJO", "AMARILLO", "VERDE", "AZUL", "LILA", "ROSA", "NEGRO", "CAFE", "TURQUESA", "BLANCO", "NARANJA", "PLOMO"];
    var color = ["red", "yellow", "green", "blue", "purple", "pink", "black", "saddlebrown", "turquoise", "white", "orange", "darkgrey"];
...
function endGame() {
    jQuery('.time').html('<p>Felicidades, lograste ' + points + ' puntos.<br>Fallaste ' + noPoints + ' veces.</p><p>Tu puntaje final es ' + (points - noPoints) + '.</p>');
